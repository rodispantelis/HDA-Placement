...
public class GA_c {
	...
	/** available nodes; nodes capable to host the minimum capacity VN of the chain */
	...
	public GA_c(int chromes, int gnrs, int sgnrs, int cr, int mu, 
			services.HDAgraph incnet, network.FTnetwork inpnet) {
	...
	public void genpop(){
		...
		//nodes the available capacity of which is larger than the minimum demand of the VNs
